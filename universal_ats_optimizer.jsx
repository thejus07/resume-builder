...
export default function ATSForge() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f7f7f9", fontFamily: "'DM Mono','Fira Mono',monospace" }}>
      ...
      {/* ---- NAVBAR ---- */}
      <nav style={{ background: "#fff", borderBottom: "1px solid #ebebeb", padding: "14px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 100 }}>
        ...
        <div style={{ fontSize: 10, color: "#999", background: "#f8f8f8", border: "1px solid #eee", borderRadius: 20, padding: "4px 14px" }}>Powered by Claude AI</div>
      </nav>

      {/* ---- HERO ---- */}
      <div className="ats-hero" style={{ background: "linear-gradient(155deg,#18063d 0%,#2d0f6e 55%,#0f1a35 100%)", padding: "46px 40px 58px", textAlign: "center", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          <div style={{ display: "inline-block", fontSize: 10, letterSpacing: "4px", color: "#c084fc", border: "1px solid #6d28d944", borderRadius: 20, padding: "5px 18px", background: "#4c1d9520", marginBottom: 18 }}>90%+ ATS SCORE GUARANTEED</div>
